...
const CARDS = [
    { key: "all",      label: "Total Payments", sub: "All submissions",       bg: "bg-[#0d1f5c]/5", text: "text-[#0d1f5c]",  icon: DollarSign,   iconBg: "bg-[#0d1f5c]"  },
    { key: "pending",  label: "Pending",         sub: "Awaiting verification", bg: "bg-yellow-50",   text: "text-yellow-900", icon: Clock,        iconBg: "bg-yellow-500"  },
    { key: "verified", label: "Verified",         sub: "Successfully processed",bg: "bg-green-50",  text: "text-green-900",  icon: CheckCircle2, iconBg: "bg-green-500"   },
...
export function PaymentStats({ stats, onFilterChange }) {
    const values = { all: stats.total, pending: stats.pending, verified: stats.verified, rejected: stats.rejected };
    return (
