...
export function CategorySelection({ onSelectCategory }) {
    ...
    return (
        <div className="w-full">
            <div className="text-center mb-6 sm:mb-8 px-3 sm:px-0">
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 px-3 sm:px-0">
                        ...
                        >
                            ...
                            >
                                ...
                                <CardHeader className="relative z-10 pb-3 sm:pb-6">
                                    <div className="flex justify-center mb-3 sm:mb-4">
                                        <div className={`relative p-3 sm:p-4 ${colors.icon} rounded-2xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg`}>
                                    ...
                                    <CardTitle className="text-base sm:text-xl text-center mb-2 group-hover:text-gray-900 transition-colors">
                                        {category.title}
                                    </CardTitle>
                                </CardHeader>
                                <CardContent className="flex-1 flex flex-col relative z-10 pt-0">
                                    <CardDescription className="text-gray-700 text-center flex-1 flex items-center justify-center mb-3 sm:mb-4 text-xs sm:text-sm leading-relaxed">
                                        {category.description}
                                    </CardDescription>
                                    <div className="flex flex-col sm:flex-row gap-2 mt-auto">
                                        <Button
                                            onClick={() => onSelectCategory(category.id)}
                                            className={`flex-1 h-9 sm:h-10 ${colors.button} text-white shadow-md hover:shadow-xl transform hover:scale-105 transition-all duration-300 text-xs sm:text-sm`}
                                        >
                                        ...
                                        <Button
                                            ...
                                            className="flex-1 h-9 sm:h-10 hover:bg-gray-50 hover:border-gray-300 transform hover:scale-105 transition-all duration-300 text-xs sm:text-sm"
                                        >
            ...
            <div className="mt-6 sm:mt-8 mx-3 sm:mx-0 p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            {/* Requirements Dialog - Responsive */}
            <Dialog open={isRequirementsOpen} onOpenChange={setIsRequirementsOpen}>
                <DialogContent className="max-w-[95vw] sm:max-w-4xl max-h-[85vh] overflow-y-auto bg-gradient-to-br from-blue-50 to-slate-50">
                    <DialogHeader>
                        <DialogTitle className="text-lg sm:text-2xl flex items-center gap-2">
                            ...
                            <span className="text-sm sm:text-2xl">Requirements for {selectedRequirements?.title}</span>
                        </DialogTitle>
                    ...
                    <div className="mt-4 sm:mt-6 space-y-2 sm:space-y-3">
                        {selectedRequirements?.requirements.map((requirement, index) => (
                            <div 
                                key={index} 
                                className="bg-white p-3 sm:p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-200 flex items-start gap-2 sm:gap-4 animate-fadeInUp"
                                style={{ animationDelay: `${index * 50}ms` }}
                            >
                                <div className="flex-shrink-0 mt-1">
                                    <div className="flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-blue-100 text-blue-600 font-semibold text-xs sm:text-sm">
                                        {index + 1}
                                    </div>
                                </div>
                                <div className="flex-1">
                                    <p className="text-gray-800 leading-relaxed text-xs sm:text-base">{requirement}</p>
                                </div>
                    ...
                    <div className="mt-4 sm:mt-6 p-3 sm:p-5 bg-white border-l-4 border-yellow-500 rounded-lg shadow-md">
                        <div className="flex items-start gap-2 sm:gap-3">
                            ...
                            <div className="flex-1">
                                <h4 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">Important Notice</h4>
