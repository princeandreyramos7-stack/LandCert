        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 border-b pb-2">
                    Main Requirements <span className="text-red-500">*</span>
                </h3>
                    ...
                    return (
                        <Card key={requirement.id} className="p-4">
                            <div className="space-y-3">
                                ...
                                {existingDocuments[requirement.id] && existingDocuments[requirement.id].length > 0 && (
                ...
                <div className="space-y-4">
                    <div className="border-t pt-6">
                        ...
                        <p className="text-sm text-gray-600 mt-2 mb-4">
                            ...
                            <br />
                            <span className="font-semibold text-red-600">Note: Barangay Clearance is required for all applications.</span>
                        </p>
                    </div>
                    {additionalRequirements.map((requirement) => {
                        ...
                        // Check if this is Barangay Clearance (make it required)
                        const isBarangayClearance = requirement.name.toLowerCase().includes('barangay');
                        const isRequired = requirement.required || isBarangayClearance;

                        return (
                            <Card key={requirement.id} className={`p-4 ${isBarangayClearance ? '' : ''}`}>
                                <div className="space-y-3">
                                    <div className="flex items-start justify-between gap-3">
                                        <div className="flex-1">
                                            <Label className="text-base font-semibold text-gray-900">
                                                ...
                                                {!isRequired && <span className="text-gray-500 ml-1 text-sm font-normal">(Optional)</span>}
                                            </Label>
                                            {requirement.description && (
                                                <p className="text-sm text-gray-600 mt-1 whitespace-pre-line">
                                                    {requirement.description}
