 ...
 */
export function ApplicationsBoard({ requests, role, exportRoute }) {
    ...
    const rows = useMemo(() => {
        ...
        const list = all.filter((r) =>
            matchesStatusFilter(r.status, status)
    ...
    const clear = () => { setSearch(""); setStatus("all"); setType("all"); };
    ...
    return (
        <div className="space-y-4 p-4 sm:p-6">
            ...
            <div className="rounded-xl border border-gray-100 bg-white shadow-sm">
                ...
                <ApplicationsTable requests={pageRows} role={role} filtered={Boolean(search) || status !== "all" || type !== "all"} />
