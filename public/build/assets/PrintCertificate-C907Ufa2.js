import{r,j as t,H as c}from"./app-D6H0PsXE.js";import"./button-D2iwCgo5.js";import{h as p}from"./html2pdf-B0xhZYKi.js";import{z as h}from"./signerName-BRhPV7Ta.js";import{P as g}from"./printer-CPm1HO_r.js";import{D as x}from"./download-CKprL4ZN.js";import"./index-AhNjY6oh.js";import"./loader-circle-C0dbezLx.js";import"./createLucideIcon-CBWk4H6_.js";function w({application:e,payment:i,reviewer:o}){const n=r.useRef(null);r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=n.current,a={margin:0,filename:`Certificate_${e.application_number||"Certificate"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};p().set(a).from(l).save()};return t.jsxs(t.Fragment,{children:[t.jsx(c,{title:`Certificate - ${e.application_number}`}),t.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
