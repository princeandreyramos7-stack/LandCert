import{r,j as t,H as p}from"./app--IyP0PPw.js";import"./button-DaLbv7Aj.js";import{h as m}from"./html2pdf-B260Korn.js";import{z as g}from"./signerName-BRhPV7Ta.js";import{T as h}from"./TupClearanceLetter-DxQs0rnd.js";import{P as f}from"./printer-BcEW3AtI.js";import{D as x}from"./download-CRSYJSby.js";import"./index-C3Qr1Ilh.js";import"./loader-circle-C3y1Here.js";import"./createLucideIcon-D6K0_Bdp.js";import"./OfficialLetterhead-D4qFdblA.js";import"./ESignatureImage-pPonQz7r.js";function D({application:e,payment:n,reviewer:o}){const i=r.useRef(null),a=String(e.project_type||"").toUpperCase()==="TUP";r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=i.current,c={margin:0,filename:`Clearance_${e.application_number||"Clearance"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};m().set(c).from(l).save()};return t.jsxs(t.Fragment,{children:[t.jsx(p,{title:`Clearance - ${e.application_number}`}),t.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
