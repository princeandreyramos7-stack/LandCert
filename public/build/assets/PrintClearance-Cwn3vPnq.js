import{r,j as t,H as p}from"./app-C6fvZUh-.js";import"./button-CqalaHWV.js";import{h as m}from"./html2pdf-CHl57qI1.js";import{z as g}from"./signerName-BRhPV7Ta.js";import{T as h}from"./TupClearanceLetter-DFfqLOas.js";import{P as f}from"./printer-_fvzQU9P.js";import{D as x}from"./download-C5SvYu-s.js";import"./index-DIqET_Zi.js";import"./loader-circle-BdtPRKfk.js";import"./createLucideIcon-DNL55xcW.js";import"./OfficialLetterhead-CieCMmI4.js";import"./ESignatureImage-CtB_WkV_.js";function D({application:e,payment:n,reviewer:o}){const i=r.useRef(null),a=String(e.project_type||"").toUpperCase()==="TUP";r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=i.current,c={margin:0,filename:`Clearance_${e.application_number||"Clearance"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};m().set(c).from(l).save()};return t.jsxs(t.Fragment,{children:[t.jsx(p,{title:`Clearance - ${e.application_number}`}),t.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
