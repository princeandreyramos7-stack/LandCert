import{r,j as e,H as p}from"./app-pUjmMqSl.js";import{h as m}from"./html2pdf-lYFuw5Df.js";import{z as g}from"./signerName-BRhPV7Ta.js";import{T as h}from"./TupClearanceLetter-rVS9JsXh.js";import{P as f}from"./printer-BvIerAI_.js";import{D as x}from"./download-D2xWVWd4.js";import"./OfficialLetterhead-BjKZQGLz.js";import"./ESignatureImage-CWLW9gh6.js";function A({application:t,payment:n,reviewer:o}){const i=r.useRef(null),a=String(t.project_type||"").toUpperCase()==="TUP";r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=i.current,c={margin:0,filename:`Clearance_${t.application_number||"Clearance"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};m().set(c).from(l).save()};return e.jsxs(e.Fragment,{children:[e.jsx(p,{title:`Clearance - ${t.application_number}`}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
