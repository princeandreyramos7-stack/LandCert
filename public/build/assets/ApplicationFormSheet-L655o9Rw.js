import{j as t}from"./app-DEKcKxDl.js";const S="CPD-001-0",s=e=>e!=null&&String(e).trim()!==""?String(e).trim():"",r=" ",i=({on:e})=>t.jsx("span",{style:{fontSize:"9pt",lineHeight:1},children:e?"☑":"☐"}),l=({val:e,w:a="80pt",inline:p=!1,pl:o="2pt",pr:c="2pt"})=>t.jsx("span",{style:{display:"inline-block",width:a,borderBottom:"1px solid #000",verticalAlign:"bottom",fontSize:"8pt",lineHeight:"1.4",paddingBottom:"3pt",paddingLeft:o,paddingRight:c},children:s(e)||r});function E(e){if(!e||isNaN(parseFloat(e)))return"";const a=["","ONE","TWO","THREE","FOUR","FIVE","SIX","SEVEN","EIGHT","NINE","TEN","ELEVEN","TWELVE","THIRTEEN","FOURTEEN","FIFTEEN","SIXTEEN","SEVENTEEN","EIGHTEEN","NINETEEN"],p=["","","TWENTY","THIRTY","FORTY","FIFTY","SIXTY","SEVENTY","EIGHTY","NINETY"];function o(n){return n<20?a[n]:n<100?p[Math.floor(n/10)]+(n%10?"-"+a[n%10]:""):n<1e3?a[Math.floor(n/100)]+" HUNDRED"+(n%100?" "+o(n%100):""):n<1e6?o(Math.floor(n/1e3))+" THOUSAND"+(n%1e3?" "+o(n%1e3):""):n<1e9?o(Math.floor(n/1e6))+" MILLION"+(n%1e6?" "+o(n%1e6):""):o(Math.floor(n/1e9))+" BILLION"+(n%1e9?" "+o(n%1e9):"")}const c=Math.floor(parseFloat(e)),m=Math.round((parseFloat(e)-c)*100);return o(c)+" PESOS"+(m?" AND "+o(m)+"/100":"")}function I(e,a){return e.replace("%03d",String(a).padStart(3,"0"))}const A=`
/* ── screen wrapper ── */
.pf-page {
    width: 210mm;
    min-height: 297mm;
