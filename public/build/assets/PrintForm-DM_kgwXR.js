import{j as t,H as R}from"./app-CX_-Znv9.js";import{h as F}from"./html2pdf-1Akb3tSE.js";import{A as L}from"./AdminLayout-mXX_-zCY.js";import{S as _}from"./SuperAdminLayout-D7YbHo5j.js";import{A as z}from"./ApplicantLayout-B4mAEVi7.js";import{D as P,F as D}from"./DocumentActionBar-BHiIyVxn.js";import"./admin-sidebar-CSJdqKAT.js";import"./breadcrumb-DXWQraPN.js";import"./index-CtQt_ndF.js";import"./user-ehFmkb5c.js";import"./layout-dashboard-Mlum4PmN.js";import"./file-text-DDGwE_rJ.js";import"./users-D9uaoBmA.js";import"./award-CCCWjxO2.js";import"./activity-CnH8X-ws.js";import"./HeaderSlot-lTV3th3q.js";import"./toaster-C29hN8XF.js";import"./use-toast-DC0yvMu3.js";import"./NotificationBell-DqcTwlCW.js";import"./bell-CCqkAdj9.js";import"./super-admin-sidebar-Bq3sYM5N.js";import"./app-sidebar-C_fwS2y9.js";import"./printer-BMQ56NAz.js";import"./download-DkY7R4Ey.js";const i=e=>e!=null&&String(e).trim()!==""?String(e).trim():"",o=" ",s=({on:e})=>t.jsx("span",{style:{fontSize:"9pt",lineHeight:1},children:e?"☑":"☐"}),r=({val:e,w:a="80pt",inline:d=!1,pl:l="2pt",pr:p="2pt"})=>t.jsx("span",{style:{display:"inline-block",width:a,borderBottom:"1px solid #000",verticalAlign:"bottom",fontSize:"8pt",lineHeight:"1.4",paddingBottom:"3pt",paddingLeft:l,paddingRight:p},children:i(e)||o});function k(e){if(!e||isNaN(parseFloat(e)))return"";const a=["","ONE","TWO","THREE","FOUR","FIVE","SIX","SEVEN","EIGHT","NINE","TEN","ELEVEN","TWELVE","THIRTEEN","FOURTEEN","FIFTEEN","SIXTEEN","SEVENTEEN","EIGHTEEN","NINETEEN"],d=["","","TWENTY","THIRTY","FORTY","FIFTY","SIXTY","SEVENTY","EIGHTY","NINETY"];function l(n){return n<20?a[n]:n<100?d[Math.floor(n/10)]+(n%10?"-"+a[n%10]:""):n<1e3?a[Math.floor(n/100)]+" HUNDRED"+(n%100?" "+l(n%100):""):n<1e6?l(Math.floor(n/1e3))+" THOUSAND"+(n%1e3?" "+l(n%1e3):""):n<1e9?l(Math.floor(n/1e6))+" MILLION"+(n%1e6?" "+l(n%1e6):""):l(Math.floor(n/1e9))+" BILLION"+(n%1e9?" "+l(n%1e9):"")}const p=Math.floor(parseFloat(e)),g=Math.round((parseFloat(e)-p)*100);return l(p)+" PESOS"+(g?" AND "+l(g)+"/100":"")}const H=`
