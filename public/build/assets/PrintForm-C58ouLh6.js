import{j as t,H as E}from"./app-D6H0PsXE.js";import{h as I}from"./html2pdf-B0xhZYKi.js";import{A as O}from"./AdminLayout-xmUzF7ZY.js";import{S as C}from"./SuperAdminLayout-BBMhDara.js";import{A as B}from"./ApplicantLayout-BAjcHjC4.js";import{D as R,F}from"./DocumentActionBar-BT4MaW1l.js";import"./admin-sidebar-DSBCGmT0.js";import"./breadcrumb-DfnjIdsA.js";import"./index-AhNjY6oh.js";import"./button-D2iwCgo5.js";import"./loader-circle-C0dbezLx.js";import"./createLucideIcon-CBWk4H6_.js";import"./index-C6NncS7k.js";import"./layout-dashboard-zTthy4Qr.js";import"./user-Cus5Zt6t.js";import"./file-text-vJ8LFqpv.js";import"./users-wZ0iJ2cR.js";import"./award-0SJM8Y24.js";import"./activity-Btv1L1xy.js";import"./HeaderSlot-CeSHuHtd.js";import"./toaster-CfrkOjJW.js";import"./use-toast-vv1TXpXv.js";import"./NotificationBell-PkRT1IB4.js";import"./bell-Dv7E1zWX.js";import"./super-admin-sidebar-Cw7KyyNN.js";import"./app-sidebar-C6xLBWaW.js";import"./printer-CPm1HO_r.js";import"./download-CKprL4ZN.js";const i=e=>e!=null&&String(e).trim()!==""?String(e).trim():"",s=" ",o=({on:e})=>t.jsx("span",{style:{fontSize:"9pt",lineHeight:1},children:e?"☑":"☐"}),r=({val:e,w:a="80pt",inline:d=!1,pl:l="2pt",pr:p="2pt"})=>t.jsx("span",{style:{display:"inline-block",width:a,borderBottom:"1px solid #000",verticalAlign:"bottom",fontSize:"8pt",lineHeight:"1.4",paddingBottom:"3pt",paddingLeft:l,paddingRight:p},children:i(e)||s});function L(e){if(!e||isNaN(parseFloat(e)))return"";const a=["","ONE","TWO","THREE","FOUR","FIVE","SIX","SEVEN","EIGHT","NINE","TEN","ELEVEN","TWELVE","THIRTEEN","FOURTEEN","FIFTEEN","SIXTEEN","SEVENTEEN","EIGHTEEN","NINETEEN"],d=["","","TWENTY","THIRTY","FORTY","FIFTY","SIXTY","SEVENTY","EIGHTY","NINETY"];function l(n){return n<20?a[n]:n<100?d[Math.floor(n/10)]+(n%10?"-"+a[n%10]:""):n<1e3?a[Math.floor(n/100)]+" HUNDRED"+(n%100?" "+l(n%100):""):n<1e6?l(Math.floor(n/1e3))+" THOUSAND"+(n%1e3?" "+l(n%1e3):""):n<1e9?l(Math.floor(n/1e6))+" MILLION"+(n%1e6?" "+l(n%1e6):""):l(Math.floor(n/1e9))+" BILLION"+(n%1e9?" "+l(n%1e9):"")}const p=Math.floor(parseFloat(e)),g=Math.round((parseFloat(e)-p)*100);return l(p)+" PESOS"+(g?" AND "+l(g)+"/100":"")}const _=`
...
`;function mt({application:e,auth:a}){const d=parseFloat(e.project_cost)||0,l=d?"₱"+d.toLocaleString("en-PH",{minimumFractionDigits:2}):"",p=d?L(d):"",g=i(e.application_number)||z("TPZ-%s-%04d",new Date().toISOString().slice(5,7)+"-"+new Date().toISOString().slice(2,4),e.id);i(e.decision_number)||""+new Date().toISOString().slice(5,7)+new Date().toISOString().slice(2,4);const n="CPD-001-0",b=a?.user?a.user.user_type||a.user.role:null,f=b==="super_admin",y=b==="admin",N=f?C:y?O:B,v=f?[{label:"Dashboard",href:"/super-admin/dashboard"},{label:"Applications",href:"/super-admin/requests"},{label:"Print Form"}]:y?[{label:"Dashboard",href:"/admin/dashboard"},{label:"Applications",href:"/admin/requests"},{label:"Print Form"}]:[],w=()=>{const x=`CPDO_Form_${n}_${i(e.applicant_name).replace(/\s+/g,"_")}.pdf`,m=document.createElement("div");m.style.cssText="background: white; padding: 0; margin: 0;",document.querySelectorAll(".pf-page").forEach((S,A)=>{const j=S.cloneNode(!0);j.classList.remove("no-border"),j.style.cssText=`
                margin: 0;
                padding: 7mm 8mm;
                border: none;
                background: white;
