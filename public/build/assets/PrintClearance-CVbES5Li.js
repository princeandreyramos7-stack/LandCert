import{r,j as t,H as p}from"./app-Box7yvcC.js";import"./button-DKDLecBU.js";import{h as m}from"./html2pdf-BWZ-2GHg.js";import{z as g}from"./signerName-BRhPV7Ta.js";import{T as h}from"./TupClearanceLetter-CkNxULMQ.js";import{P as f}from"./printer-BCsE_Egf.js";import{D as x}from"./download-DVZSevjC.js";import"./index-CSPIh6jB.js";import"./loader-circle-Dkjsgxlk.js";import"./createLucideIcon-j2SBMnuZ.js";import"./OfficialLetterhead-CkmDHEQ7.js";import"./ESignatureImage-D7I2YerO.js";function D({application:e,payment:n,reviewer:o}){const i=r.useRef(null),a=String(e.project_type||"").toUpperCase()==="TUP";r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=i.current,c={margin:0,filename:`Clearance_${e.application_number||"Clearance"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};m().set(c).from(l).save()};return t.jsxs(t.Fragment,{children:[t.jsx(p,{title:`Clearance - ${e.application_number}`}),t.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
