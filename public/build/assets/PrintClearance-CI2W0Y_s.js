import{r,j as t,H as p}from"./app-tMAF2q-o.js";import"./button-CwyjwzgN.js";import{h as m}from"./html2pdf-CiwlUgbb.js";import{z as g}from"./signerName-BRhPV7Ta.js";import{T as h}from"./TupClearanceLetter-DEL6JqQv.js";import{P as f}from"./printer-kfxDAUbY.js";import{D as x}from"./download-DDLiugwr.js";import"./index-Dd2S5-6Z.js";import"./loader-circle-D7PIndho.js";import"./createLucideIcon-CfaJCh9f.js";import"./OfficialLetterhead-DZKF0x7l.js";import"./ESignatureImage-BHQvFB4E.js";function D({application:e,payment:n,reviewer:o}){const i=r.useRef(null),a=String(e.project_type||"").toUpperCase()==="TUP";r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=i.current,c={margin:0,filename:`Clearance_${e.application_number||"Clearance"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};m().set(c).from(l).save()};return t.jsxs(t.Fragment,{children:[t.jsx(p,{title:`Clearance - ${e.application_number}`}),t.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
