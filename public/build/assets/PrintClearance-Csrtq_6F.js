import{r,j as e,H as p}from"./app-a1zpYqa6.js";import{h as m}from"./html2pdf-BhtTPlho.js";import{z as g}from"./signerName-BRhPV7Ta.js";import{T as h}from"./TupClearanceLetter-hyCF4lm4.js";import{P as f}from"./printer-DYAy4Jtt.js";import{D as x}from"./download-C5vAEBv-.js";import"./OfficialLetterhead-Bzv0VRQb.js";import"./ESignatureImage-CEWAkRRw.js";function A({application:t,payment:n,reviewer:o}){const i=r.useRef(null),a=String(t.project_type||"").toUpperCase()==="TUP";r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=i.current,c={margin:0,filename:`Clearance_${t.application_number||"Clearance"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};m().set(c).from(l).save()};return e.jsxs(e.Fragment,{children:[e.jsx(p,{title:`Clearance - ${t.application_number}`}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
