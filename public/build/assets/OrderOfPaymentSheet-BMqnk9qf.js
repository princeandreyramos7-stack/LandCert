import{r as g,j as e}from"./app-DuUI8qp1.js";import{O as x,z as f,E as y}from"./signerName-BJ-wEMRL.js";function j(a){const i=Math.round(Number(a)||0);if(i<=0)return"";const o=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],s=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"],d=t=>{let n="";return t>=100&&(n+=o[Math.floor(t/100)]+" Hundred",t%=100,t&&(n+=" ")),t>=20?(n+=s[Math.floor(t/10)],t%=10,t&&(n+="-"+o[t])):t>0&&(n+=o[t]),n},h=[""," Thousand"," Million"," Billion"];let r="",p=0,l=i;for(;l>0;){const t=l%1e3;t&&(r=d(t)+h[p]+(r?" "+r:"")),l=Math.floor(l/1e3),p++}return`${r} Pesos`}function m({label:a,signatureUrl:i,name:o,title:s}){return e.jsxs("div",{children:[e.jsx("div",{style:{position:"relative",height:"30pt",display:"flex",alignItems:"flex-end",justifyContent:"center",width:"240pt"},children:e.jsx(y,{src:i,maxHeight:"30pt",maxWidth:"150pt",marginBottom:"-3pt"})}),e.jsxs("div",{style:{fontWeight:"bold"},children:[a,": ",o]}),e.jsx("div",{style:{marginTop:"3pt"},children:s})]})}const _=`
.payment-page {
    width: 8.5in;
    min-height: 11in;
    margin: 0 auto;
