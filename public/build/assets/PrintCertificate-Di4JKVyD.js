import{r,j as t,H as c}from"./app--IyP0PPw.js";import"./button-DaLbv7Aj.js";import{h as p}from"./html2pdf-B260Korn.js";import{z as h}from"./signerName-BRhPV7Ta.js";import{P as g}from"./printer-BcEW3AtI.js";import{D as x}from"./download-CRSYJSby.js";import"./index-C3Qr1Ilh.js";import"./loader-circle-C3y1Here.js";import"./createLucideIcon-D6K0_Bdp.js";function w({application:e,payment:i,reviewer:o}){const n=r.useRef(null);r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=n.current,a={margin:0,filename:`Certificate_${e.application_number||"Certificate"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};p().set(a).from(l).save()};return t.jsxs(t.Fragment,{children:[t.jsx(c,{title:`Certificate - ${e.application_number}`}),t.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
