import{j as t,H as R}from"./app-C1xHIwul.js";import{h as F}from"./html2pdf-WLtpoKjv.js";import{A as L}from"./AdminLayout-CsxIACye.js";import{S as _}from"./SuperAdminLayout-JP36m0tQ.js";import{A as z}from"./ApplicantLayout-BQg2IEn-.js";import{D as P,F as k}from"./DocumentActionBar-C6ARJfP9.js";import"./admin-sidebar-IKiD5GR_.js";import"./breadcrumb-BDzMDeiV.js";import"./SealWatermark-DrMLWWlt.js";import"./user-DCJUIEYE.js";import"./layout-dashboard-BaY7AKj0.js";import"./file-text-3B77LSWn.js";import"./users-DPbJPSgs.js";import"./award-BnmAphXZ.js";import"./activity-CPH3-47Q.js";import"./HeaderSlot-C-TXdVkc.js";import"./toaster-wSk6hLxr.js";import"./NotificationBell-DAo2S-wE.js";import"./bell-agCSuW7A.js";import"./super-admin-sidebar-KESjrcl0.js";import"./app-sidebar-D2Lf9Jzl.js";import"./folder-open-D08PhSH0.js";import"./printer-Cz-xw8bC.js";import"./download-DH6HRtkQ.js";const i=e=>e!=null&&String(e).trim()!==""?String(e).trim():"",o=" ",s=({on:e})=>t.jsx("span",{style:{fontSize:"9pt",lineHeight:1},children:e?"☑":"☐"}),r=({val:e,w:l="80pt",inline:d=!1,pl:a="2pt",pr:p="2pt"})=>t.jsx("span",{style:{display:"inline-block",width:l,borderBottom:"1px solid #000",verticalAlign:"bottom",fontSize:"8pt",lineHeight:"1.4",paddingBottom:"3pt",paddingLeft:a,paddingRight:p},children:i(e)||o});function D(e){if(!e||isNaN(parseFloat(e)))return"";const l=["","ONE","TWO","THREE","FOUR","FIVE","SIX","SEVEN","EIGHT","NINE","TEN","ELEVEN","TWELVE","THIRTEEN","FOURTEEN","FIFTEEN","SIXTEEN","SEVENTEEN","EIGHTEEN","NINETEEN"],d=["","","TWENTY","THIRTY","FORTY","FIFTY","SIXTY","SEVENTY","EIGHTY","NINETY"];function a(n){return n<20?l[n]:n<100?d[Math.floor(n/10)]+(n%10?"-"+l[n%10]:""):n<1e3?l[Math.floor(n/100)]+" HUNDRED"+(n%100?" "+a(n%100):""):n<1e6?a(Math.floor(n/1e3))+" THOUSAND"+(n%1e3?" "+a(n%1e3):""):n<1e9?a(Math.floor(n/1e6))+" MILLION"+(n%1e6?" "+a(n%1e6):""):a(Math.floor(n/1e9))+" BILLION"+(n%1e9?" "+a(n%1e9):"")}const p=Math.floor(parseFloat(e)),g=Math.round((parseFloat(e)-p)*100);return a(p)+" PESOS"+(g?" AND "+a(g)+"/100":"")}const H=`
