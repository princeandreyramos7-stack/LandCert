import{r,j as t,H as p}from"./app-CFgWr9lf.js";import"./button-B0TO1ZYy.js";import{h as m}from"./html2pdf-DdBcx6p-.js";import{z as g}from"./signerName-BRhPV7Ta.js";import{T as h}from"./TupClearanceLetter-B9Gx7rpx.js";import{P as f}from"./printer-B5GhAPW6.js";import{D as x}from"./download-CClhbj5P.js";import"./index-BM2JWor9.js";import"./loader-circle-B68EYlA4.js";import"./createLucideIcon-BG25J2Cm.js";import"./OfficialLetterhead-BaKM0N4M.js";import"./ESignatureImage-Djb94d8W.js";function D({application:e,payment:n,reviewer:o}){const i=r.useRef(null),a=String(e.project_type||"").toUpperCase()==="TUP";r.useEffect(()=>{},[]);const s=()=>{window.print()},d=()=>{const l=i.current,c={margin:0,filename:`Clearance_${e.application_number||"Clearance"}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0,logging:!1},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:"avoid-all"}};m().set(c).from(l).save()};return t.jsxs(t.Fragment,{children:[t.jsx(p,{title:`Clearance - ${e.application_number}`}),t.jsx("style",{dangerouslySetInnerHTML:{__html:`
                body {
                    margin: 0;
                    padding: 0;
                    background: #f5f5f5;
